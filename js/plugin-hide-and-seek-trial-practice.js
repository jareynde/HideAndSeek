var jsPsychHideAndSeekContextsTrialpractice = (function (jspsych) {
    'use strict';
    ...
    **/
    ...
    class HideAndSeekContextsTrialPracticePlugin {
      constructor(jsPsych) {
    ...
    HideAndSeekContextsTrialPracticePlugin.info = info;
  
    return HideAndSeekContextsTrialPracticePlugin;
