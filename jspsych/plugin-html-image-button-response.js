var jsPsychHtmlImageButtonResponse = (function (jspsych) {
    'use strict';
    ...
    class HtmlButtonResponsePlugin {
        ...
        trial(display_element, trial) {
            ...
            // create a container for stimulus and buttons with relative positioning
            html += '<div id="jspsych-html-button-response-container" style="position: relative;">';

            // display stimulus
            html += '<div id="jspsych-html-button-response-stimulus" style="position: absolute; top: 0; left: 0;">' + trial.stimulus + '</div>';
